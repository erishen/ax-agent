...
// Inspector panel for the AX tree: app picker → tree dump → node detail +
// actuation. Split out of App.tsx so the shell stays tiny; this file owns all
// of the read-the-system-UI surface (permission gate, tree, screenshots).
